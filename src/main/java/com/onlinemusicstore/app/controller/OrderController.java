...
public class OrderController {
	...
	public String showCustomerOrder (@PathVariable("id") int id, Model model) {
		...
		List<CustomerOrder> customerOrders = orderService.getOrdersByCustomerId(id);
		...
		System.out.println("displaying the orders");
		return "../showOrderOfCustomer.jsp";
	...
	public String customerOrderDetailByOrderId(@PathVariable("orderId") int orderId, Model model) {
		List<OrderDetailBean> orderDetails = orderService.getOrderDetailById(orderId);
