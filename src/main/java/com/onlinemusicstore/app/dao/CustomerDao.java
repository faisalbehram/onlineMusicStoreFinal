...
//	private CustomerRepository customerRepository;
	...
	public Customer getByUserName(String username) {
		System.out.println("in findbyUsername in customer Dao  the username given is " + username );
	...
	public Customer customerInfo(String userName) {
		return customerJdbcRepo.customerInfo(userName);
	}
	...
	public List<CustomerCountBean> countCustomer() {
		return customerJdbcRepo.getCustomerCountVMonth();
	}

	public void updateProfile(Customer updateCustomer) {
		customerJdbcRepo.updateProfile(updateCustomer);
