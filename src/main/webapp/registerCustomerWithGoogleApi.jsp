...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
        	...
        	<h4 style="color: #ff0000"> ${captchaError}</h4>
		<form:form action="/registercustomer" method="post"
                   modelAttribute="billingAddress" enctype="multipart/form-data"  >
        <h3>Basic Info</h3>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <p style="color: #ff0000"> ${errors1}</p>
        </div>
    ...
    <input type="hidden" id="loc_long" />
		 ...
		 <div class="form-group">
            <label for="productImage">Profile Picture</label>
            <input type="file" name="profileImage" id="profileImage" class="form-Control" />
        </div>
        
        <div class="g-recaptcha"
   			 data-sitekey="6Ld_WdYUAAAAAFrvhTUx8k-OBS9qt7GEHSjdoVgb">
   			  </div>
		 <div>
