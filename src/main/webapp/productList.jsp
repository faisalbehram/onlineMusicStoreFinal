            ...
            <c:forEach items="${products}" var="product" >
                <tr>
                    ...
                    <td>${product.productName}</td>
                      			...
                      			<td>
                      			<c:forEach items="${mainCategories}" var="mainCategory" >
                      			<c:if test="${product.category.id == mainCategory.id || product.category.id == subCategory.parentId}">
                      			...
                      			<c:if test="${product.category.id == subCategory.id}">
                      			 ${ subCategory.categoryName} </c:if></c:forEach> </td>
            		...
            		<c:forEach items="${discounts}" var="discountprice" >
            				<c:choose>
            					<c:when test="${discountprice.proId.productId == product.productId}">
            					...
            					<c:forEach items="${categoryDiscounts}" var="CategoryDiscount" >
           						...
           						<c:if test ="${CategoryDiscount.proId.productId == product.productId  }" >
